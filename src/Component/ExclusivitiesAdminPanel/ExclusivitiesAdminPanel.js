                                    ...
                                    <div className="row">
                                        ...
                                        <div style={{ display: 'flex', alignItems: 'center', gap: 10 + 'px'}}>
                                            ...
                                            <p style={{textAlign: 'center'}}>{currentExclusivity.To===1 ? (
                                                <span style={{ backgroundColor: 'lightpink', color: 'deeppink', padding: 0.3 + 'rem', display: 'flex', alignItems: 'center', justifyContent: 'center', border: 0.05 + 'px solid deeppink', borderRadius: 12 + 'px'}}>
