    ...
    if (!loadedData) {
        ...
        return (
            <div className="bg-gradient" onLoad={init} >
                                ...
                                <div className="form">
                                    ...
                                    <div style={{ display: 'flex', alignItems: 'center', gap: 10 + 'px'}}>
                                        <label className="switch">
                                            <input 
                                                type="checkbox"
                                                checked={newExclusivity.To}
                                                onChange={(e) => {
                                                    if (e.target.checked) {
                                                        setNewExclusivity({ ...newExclusivity, To: 1 });
                                                    } else {
                                                        setNewExclusivity({ ...newExclusivity, To: 0 });
                                                    }
                                                }}
                                                />
                                            <span className="slider2"></span> 
                                        </label> 
                                        <p style={{textAlign: 'center'}}>{newExclusivity.To===1 ? (
                ...
                <div className="container" style={{margin: 20 + 'px auto', maxWidth: 87 + '%'}}>
                    <div className="tabs">
